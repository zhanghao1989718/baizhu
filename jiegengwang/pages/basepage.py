...
from jiegengwang.common.cappic import Cappic
...
class BasePage(object):
    ...
    def wait(self, seconds):
        ...
        mylogger.info("隐性等待 %d 秒" % seconds)
