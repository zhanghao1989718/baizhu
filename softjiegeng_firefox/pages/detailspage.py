...
from softjiegeng_firefox.pages.basepage import BasePage
...
class DetailsPage(BasePage):
    ...
    def detailspage(self):
        self.click_by_xpath('/html/body/div[2]/div/div[1]/h1/a/img')
        self.back()
        ...
        self.click_by_xpath('/html/body/div[5]/div/div[1]/div/div[1]/div')
        self.click_by_xpath('/html/body/div[5]/div/div[1]/div/div[2]/span[1]/b')
        self.click_by_xpath('/html/body/div[5]/div/div[1]/div/div[2]/span[2]/b')
        self.clicks_by_xpath('/html/body/div[5]/div/div[2]/ul/li/a')
